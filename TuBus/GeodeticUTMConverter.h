...
static inline UTMCoordinates UTMCoordinatesMake(double northing, double easting, UTMGridZone gridZone, UTMHemisphere hemisphere)
{
...
static inline UTMDatum UTMDatumMake(double equitorialRadius, double polarRadius)
{
    UTMDatum UTMDatum;
